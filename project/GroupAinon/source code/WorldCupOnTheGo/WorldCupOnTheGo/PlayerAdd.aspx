                    ...
                    <div class="card mb-4 mb-lg-0">
                        <div class="card-body">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <asp:RequiredFieldValidator ID="reqJerseyNo" runat="server" ErrorMessage="RequiredFieldValidator" EnableClientScript="False" ControlToValidate="txtJercyNo" Text="*Required field" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
