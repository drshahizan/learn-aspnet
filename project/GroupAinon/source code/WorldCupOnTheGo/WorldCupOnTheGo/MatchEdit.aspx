<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MatchEdit.aspx.cs" Inherits="WorldCupOnTheGo.MatchEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="py-5 container">
        <div class="card-body">
            ...
            <div class="mb-2">
                <asp:Button ID="btnSubmit" runat="server" Text="Update" CssClass="btn btn-success my-2" OnClick="btnSubmit_Click" />
