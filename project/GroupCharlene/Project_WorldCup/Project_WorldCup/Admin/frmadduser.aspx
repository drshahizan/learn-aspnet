            ...
            <table class="table mg-b-0">
                <tr>
                 ...
                 <tr>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="** Please insert your First Name" ControlToValidate="txtFirstName">**</asp:RequiredFieldValidator>
                    <td>
                        <asp:TextBox ID="txtFirstName" runat="server" Height="33px" Width="170px"></asp:TextBox>

                    </td>
                </tr>
                <tr>
                    <td scope="row" class="auto-style2">Last Name</td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="** Please insert your Last Name" ControlToValidate="txtLastName">**</asp:RequiredFieldValidator>
                    <td>
                        <asp:TextBox ID="txtLastName" runat="server" Height="33px" Width="170px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" class="button" runat="server" Text="Save" Width="87px" OnClick="btnSave_Click" /></td>
                    <td></td>
                </tr>
            </table>
        </div>
